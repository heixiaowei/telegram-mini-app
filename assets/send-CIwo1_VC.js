import{N as f,O as w,a0 as I,a3 as x,a9 as H,ai as l,Q as u,X as z,a7 as W,a6 as g,ah as L,aj as q,a5 as B,a1 as F,a2 as M,a4 as Y}from"./index-B0dE6QNp.js";import{n as d,r as c,c as m,U as b,o as K}from"./if-defined-Ce6mN8uO.js";import"./index-DHjyuZcH.js";import"./index-WEEOo51u.js";import{e as O,n as D}from"./ref-B3rqZc6d.js";import{n as Q,s as X}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-Bw5OCLw-.js";import{S as G}from"./index-CzlzxGJ6.js";import"./index-llGzB934.js";import"./index-ONMeOG8A.js";import"./index-DjDHEU-w.js";import"./index-Ct_5hu6u.js";import"./index-DX6KqAxJ.js";const J=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var j=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var a=o.length-1;a>=0;a--)(s=o[a])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(e){var n,r;const i=e.data;if(i&&((n=this.inputElementRef)!=null&&n.value))if(i===","){const t=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=t,this.value=`${this.value}${t}`}else Q.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(X,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(r=this.inputElementRef.value)==null?void 0:r.value,bubbles:!0,composed:!0}))}};C.styles=[z,W,Z];j([d({type:Boolean})],C.prototype,"disabled",void 0);j([d({type:String})],C.prototype,"value",void 0);j([d({type:String})],C.prototype,"placeholder",void 0);C=j([m("wui-input-amount")],C);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
