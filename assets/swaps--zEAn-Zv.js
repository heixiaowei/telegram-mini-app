import{Y as P,Z as C,ac as D,aq as _,a0 as u,a4 as K,aa as W,af as S,a8 as j,a9 as V,$ as M,ab as F,ad as Q,a5 as q,ag as H}from"./index-BkyvsL1j.js";import{r as s,n as h,c as E,U as m}from"./if-defined-DIFH1M3c.js";import"./index-BMM-WSzA.js";import{M as L}from"./index-ClagXwBM.js";import"./index-CvsCi2PW.js";import{S as n}from"./index-Dswjho00.js";import"./index-Blu02sZ1.js";import"./index-CiHjAr4L.js";import"./index-BHxcfpWr.js";import"./index-XxOss6HX.js";import"./index-DGj72YpX.js";import"./ref-KxKJZms2.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",R=r==="x",U=i===",",B=i===".",N=i>="0"&&i<="9";!a&&(l||x||v||R)&&c.preventDefault(),t==="0"&&!U&&!B&&i==="0"&&c.preventDefault(),t==="0"&&N&&(e(i),c.preventDefault()),(U||B)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!N&&!o.includes(i)&&!B&&!U&&c.preventDefault()}},Y=P`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,o){var a=arguments.length,i=a<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(a<3?r(i):a>3?r(t,e,i):r(t,e))||i);return a>3&&i&&Object.defineProperty(t,e,i),i};let O=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};O.styles=[X];z([h()],O.prototype,"target",void 0);O=z([E("w3m-swap-input-skeleton")],O);const J=P`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
