import{N as E,X as j,a7 as z,O as v,Q as u,a8 as _,a6 as l,R as h,a0 as x,a5 as f,a3 as D,a9 as P,aa as R,a1 as c,P as V,ab as M,Y as B}from"./index-B0dE6QNp.js";import{n as I,c as d,r as m,U as N}from"./if-defined-Ce6mN8uO.js";import"./index-Bw5OCLw-.js";import"./index-DX6KqAxJ.js";import"./index-WEEOo51u.js";import{e as H,n as q}from"./ref-B3rqZc6d.js";import"./index-DHjyuZcH.js";import"./index-y1YfzW7x.js";import"./index-llGzB934.js";const Y=E`
  :host {
    position: relative;
...
`;var T=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let g=class extends v{constructor(){super(...arguments),this.disabled=!1,this.value=""}render(){return u`<input
      ...
      value=${this.value}
    /> `}};g.styles=[j,z,Y];T([I({type:Boolean})],g.prototype,"disabled",void 0);T([I({type:String})],g.prototype,"value",void 0);g=T([d("wui-input-numeric")],g);const K=E`
  :host {
    position: relative;
    display: block;
  }
...
`;var O=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};const Q=6;let p=class extends v{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){var e;super(),this.loading=!1,this.timeoutTimeLeft=_.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=(e=l.state.data)==null?void 0:e.email,this.authConnector=h.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const e=!!this.timeoutTimeLeft,t=this.getFooterLabels(e);return u`
      <wui-flex
