import{P as p,aF as R,a6 as l,N as y,X as D,O as C,Q as c,ad as B,a7 as re,aA as le,a3 as h,aj as L,at as ce,ae as K,a1 as q,aa as T,R as z,$ as F,a5 as E,aB as P,T as de,aK as ue,au as pe,a0 as he,Y as we}from"./index-B0dE6QNp.js";import{c as b,n as u,r as d,o as M,U as me}from"./if-defined-Ce6mN8uO.js";import"./index-CebayUBL.js";import"./index-Ct_5hu6u.js";import"./index-WEEOo51u.js";import"./index-xeoeV90J.js";import"./index-DX6KqAxJ.js";import"./index-7cuVo8Kj.js";import"./index-DwDuPoHE.js";const ee={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){p.shake();return}if(await R.isSIWXCloseDisabled()){p.shake();return}p.close()}},fe=y`
  :host {
    display: block;
...
`;var be=function(n,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,i);else for(var r=n.length-1;r>=0;r--)(s=n[r])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let V=class extends C{render(){return c`<slot></slot>`}};V.styles=[D,fe];V=be([b("wui-card")],V);const ge=y`
  :host {
    display: flex;
    align-items: center;
...
`;var oe=function(n,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,i);else for(var r=n.length-1;r>=0;r--)(s=n[r])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let j=class extends C{constructor(){super(...arguments),this.imageSrc=""}render(){return c`<button>
      ${this.imageTemplate()}
    ...
    ></wui-icon-box>`}};j.styles=[D,re,le,Ce];oe([u()],j.prototype,"imageSrc",void 0);j=oe([b("wui-select")],j);const xe=y`
  :host {
    height: 64px;
  }
